...
# Initialize Session State arrays safely to protect navigation contexts
...
# =====================================================================
# PART 5 & 6 — AUDIO EXTRACTION & PROCESSING (REAL-TIME CONVERSION FIXED)
# =====================================================================
            ...
            <script>
                function initializeWebSpeechEngine() {
                    ...
                    if (!window.SpeechRecognition) {
                        document.getElementById('stt_log').innerText = "❌ Browser Speech Engine is unsupported on this device.";
                        return;
                    }
